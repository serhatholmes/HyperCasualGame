...
namespace MalbersAnimations.Selector
{
    ...
    public class SelectorManager : MonoBehaviour
    {
        ...
        [CreateScriptableAsset] public MItemSet LoadItemSet;                                //Where do you want to spawn the Item.
        ...
        [CreateScriptableAsset] public TransformAnimation EnterAnimation;
        [CreateScriptableAsset] public TransformAnimation ExitAnimation;
        [CreateScriptableAsset] public TransformAnimation FocusItemAnim;
        [CreateScriptableAsset] public TransformAnimation SubmitItemAnim;
